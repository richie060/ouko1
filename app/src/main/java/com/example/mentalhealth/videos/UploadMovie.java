...
public class UploadMovie extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setSupportActionBar(toolbar);
            getSupportActionBar().setTitle("Upload Course Videos ");

        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        member = new Member();
        storageReference = FirebaseStorage.getInstance().getReference("Course");
    ...
    public void ShowVideo(View view) {
        Intent intent = new Intent( UploadMovie.this, MainActivity.class);
                    ...
                    .addOnCompleteListener(new OnCompleteListener<Uri>() {
                        ...
                        public void onComplete(@NonNull Task<Uri> task) {
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(UploadMovie.this, "Video uploaded Succsessfully", Toast.LENGTH_SHORT).show();
                                member.setName(videoName);
                                member.setVideourl(downloadUrl.toString());
                                member.setSearch(search);
                                String i = databaseReference.push().getKey();
                                databaseReference.child(i).setValue(member);
                                Intent intent = new Intent(UploadMovie.this, Uploads.class);
                                startActivity(intent);

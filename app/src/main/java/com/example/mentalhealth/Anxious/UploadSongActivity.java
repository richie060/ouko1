package com.example.mentalhealth.Anxious;
...
public class UploadSongActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Upload songs For Anxiety ");
...
//                Log.i("image",data.toString());
    ...
    public void upload(View view){
        if (uriSong == null){
            ...
            Toast.makeText(this, "Please add Artist name", Toast.LENGTH_SHORT).show();
        }
        else if (image == null){
...
//                progressDialog.dismiss();
    ...
    public void uploadDetailsToDatabase(String songName, String songUrl, String imageUrl, String artistName, String songDuration){
        ...
        FirebaseDatabase.getInstance().getReference("ASongs")
                .push().setValue(song).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                Log.i("database", "upload success");
                progressDialog.dismiss();
                Toast.makeText(getApplicationContext(), "Song uploaded to Successfully", Toast.LENGTH_SHORT).show();

...
public class Doctor_Registration_Activity extends AppCompatActivity {
    ...
    private TextInputEditText registrationFullname, registrationIDnumber,registrationPhoneNumber,
            loginEmail, loginPassord,regspecialization;

    private Button regButton;
    private CircleImageView profileImage;
    private Uri resultUri;
//    private Spinner proffecional_spinner;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registrationIDnumber = findViewById(R.id.RgIdno);
        ...
        regButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final String proffecional = regspecialization.getText().toString();
                ...
                if (TextUtils.isEmpty(proffecional)){
                    Toast.makeText(Doctor_Registration_Activity.this, "Please Enter your specialization", Toast.LENGTH_SHORT).show();
                    return;
                }
                            ...
                            .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    if (!task.isSuccessful()){
                                        ...
                                        userInfo.put("type","therapist");
                                        userInfo.put("proffessional",proffecional);
